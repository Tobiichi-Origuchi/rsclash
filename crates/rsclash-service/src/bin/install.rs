...
#[cfg(target_os = "linux")]
fn parse_arguments() -> Result<InstallRequest, String> {
...
#[cfg(target_os = "linux")]
fn usage() -> String {
  "usage: rsclash-service-install --service-binary PATH --stable-core PATH [--alpha-core PATH] --config-root PATH".to_string()
}
